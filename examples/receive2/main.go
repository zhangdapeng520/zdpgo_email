...
import (
	"fmt"
	"github.com/zhangdapeng520/zdpgo_email/mail"
)
...
func main() {
	...
	//err := mail1.SendGoMail([]string{"zhangsan@xmirror.org"}, "你好", "这是golang测试邮件", nil)
	////err := mail1.SendGoMail([]string{"3103557991@qq.com"}, "你好", "test send", nil)
	//if err != nil {
	//	fmt.Printf("发送异常")
	//}
